...
export default function apiReducer(state = initialState, action) {
  switch (action.type) {
    case types.API_V1_BGGFJGFMH_LIST:
    case types.API_V1_BGGFJGFMH_LIST_SUCCEEDED:
    case types.API_V1_BGGFJGFMH_LIST_FAILED:
    case types.API_V1_BGGFJGFMH_CREATE:
    case types.API_V1_BGGFJGFMH_CREATE_SUCCEEDED:
    case types.API_V1_BGGFJGFMH_CREATE_FAILED:
    case types.API_V1_BGGFJGFMH_READ:
    case types.API_V1_BGGFJGFMH_READ_SUCCEEDED:
    case types.API_V1_BGGFJGFMH_READ_FAILED:
    case types.API_V1_BGGFJGFMH_UPDATE:
    case types.API_V1_BGGFJGFMH_UPDATE_SUCCEEDED:
    case types.API_V1_BGGFJGFMH_UPDATE_FAILED:
    case types.API_V1_BGGFJGFMH_PARTIAL_UPDATE:
    case types.API_V1_BGGFJGFMH_PARTIAL_UPDATE_SUCCEEDED:
    case types.API_V1_BGGFJGFMH_PARTIAL_UPDATE_FAILED:
    case types.API_V1_BGGFJGFMH_DELETE:
    case types.API_V1_BGGFJGFMH_DELETE_SUCCEEDED:
    case types.API_V1_BGGFJGFMH_DELETE_FAILED:
